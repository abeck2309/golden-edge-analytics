...
const editorialRows = [
  ...
  },
  {
    ...
    description:
      "Interactive work like VGK Trade ROI lives here, along with future long-form builds and dashboards.",
    href: "/projects",
    cta: "Browse projects"
  },
  {
    ...
    <Container className="pb-24 pt-8 md:pt-12">
      ...
      <section className="grid gap-8 pt-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
        <div className="space-y-4">
          ...
          <h2 className="font-[family-name:var(--font-heading)] text-3xl font-bold tracking-tight text-white md:text-5xl">
            VGK Trade ROI is the first live project inside the brand.
          </h2>
          <p className="max-w-2xl text-sm leading-8 text-mist md:text-base">
            The site no longer revolves solely around projects, but this is still the first major
            piece of work available now.
          </p>
        </div>
