...
export default function ProjectsPage() {
  return (
    <Container className="space-y-12 pb-20 pt-12 md:space-y-16 md:pt-16">
      <PageIntro
        eyebrow="Projects"
        title="The project library for Golden Edge Analytics."
        description="Each project gets its own page, supporting dashboards, and related articles. Right now the VGK Trade ROI release is the first live entry."
      />
          ...
          >
            <div className="border-b border-line p-5 lg:border-b-0 lg:border-r">
              <div className="relative overflow-hidden rounded-[1.35rem] border border-white/10 shadow-[0_22px_60px_rgba(0,0,0,0.38)]">
                <Image
                  src="/marner-press-conference.png"
                  alt="Press conference image for a future Golden Edge Analytics project visual"
                  width={1400}
                  height={900}
